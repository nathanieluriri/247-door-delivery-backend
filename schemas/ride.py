...
class RideUpdate(BaseModel):
    ...
    driverVehicleType: Optional[str] = None
    driverVehicleMake: Optional[str] = None
    driverVehicleModel: Optional[str] = None
    driverVehicleColor: Optional[str] = None
    driverVehiclePlateNumber: Optional[str] = None
    driverVehicleYear: Optional[int] = None
    driverHeadshotFileKey: Optional[str] = None
    driverHeadshotUrl: Optional[str] = None
